%%% snmp_collector_rest_pagination_server.erl
%%% vim: ts=3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
-module(snmp_collector_rest_pagination_server).
-copyright('Copyright (c) 2016 - 2019 SigScale Global Inc.').

-behaviour(gen_server).

%% export the snmp_collector_rest_pagination_server API
-export([start_link/1]).
...
%%----------------------------------------------------------------------
%%  The snmp_collector_rest_pagination_server API
%%----------------------------------------------------------------------
...
%% 	The result should be `{Cont, Items}' or `{error, Reason}'.
%% 	`Cont' will be `start' on the first call and the returned
%% 	value may be `eof' or an opaque continuation value which
%% 	will be used in the next call to the callback. `Size' is
%% 	the requested number of objects however the actual number
%% 	of returned objects may differ.
start_link(Args) ->
...
%%----------------------------------------------------------------------
%%  The snmp_collector_rest_pagination_server gen_server call backs
%%----------------------------------------------------------------------
