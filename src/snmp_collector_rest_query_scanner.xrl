...
%%% 	{@link //snmp_collector/snmp_collector_rest_query_parser.
%%% 			snmp_collector_rest_query_parser} in the
...
%%%  suitable for input to {@link //snmp_collector/snmp_collector_rest_query_parser.
%%%  snmp_collector_rest_query_parser}</p>
%%% @end
